...
def editData():
    tkMessageBox.showwarning('', 'Double Cleck On The Required Field To Update Data', icon="warning")
...
MidLeftPadding = Frame(Mid, width=170, bg="#6666ff")
MidLeftPadding.pack(side=LEFT)

Middle = Frame(Mid, width=100, bg="#6666ff")
Middle.pack(side=LEFT)

MidRightPadding = Frame(Mid, width=200, bg="#6666ff")
MidRightPadding.pack(side=LEFT)
...
#============================BUTTONS=====================================
btn_add = Button(MidLeft, text="+ ADD NEW", bg="#66ff66", command=AddNewWindow).pack()
btn_edit = Button(Middle, text="     UPDATE DATA     ", bg="#66ff66", command=editData)
